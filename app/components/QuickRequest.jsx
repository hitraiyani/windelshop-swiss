              ...
              <div className="comtent-info">
                <ul className="flex flex-col gap-[23px]">
                  <li>
                    <a
                      href="#"
                      className="text-[25px] flex gap-[14px] text-black font-normal items-center hover:text-[#1C5F7B]"
                    >
              ...
              <div className="form-wrap max-w-[795px] mx-auto">
                <form action="" className="flex gap-[15px] flex-col">
                  ...
                  <div className="form-group flex gap-[11px]">
                    <div className="form-control flex-1">
                      <textarea
                        className="w-full rounded-[20px] !bg-white text-[#1C5F7B] text-[16px] font-normal leading-none placeholder:!text-[#1C5F7B] placeholder:!opacity-100 focus:!border-[#1C5F7B] px-[20px] py-[16px] text-left !border-white focus:!ring-0"
                        name=""
                        id=""
                        cols="30"
                        rows="10"
                  ...
                  <div className="submit-btn">
                    <button
                      type="submit"
                      className="bg-[#1C5F7B] rounded-[30px] py-[16px] px-[20px] min-h-[50px] leading-none text-[16px] text-white text-center hover:opacity-70 transition-all duration-500 flex items-center"
                    >
                      Senden
