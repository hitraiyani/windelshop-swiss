...
import {IconChevronRight, IconStar, Link, CompareAtPrice, AddToCartButton, Text} from '~/components';
import {flattenConnection, Image, Money, useMoney} from '@shopify/hydrogen';
import {isDiscounted} from '~/lib/utils';

export function Popularproducts({className, left_section_title, right_section_title, left_section_products, right_section_products}) {
