          ...
          <div className="col relative w-[50%]">
            <div className="col-inner px-[40px] py-[30px] bg-[#E7EFFF] rounded-[30px] shadow-[2px_4px_10px_rgba(0,0,0,0.15)]">
              <div className="title-wrap mb-[35px] flex flex-wrap gap-[20px] justify-between items-center">
                <h2 className="text-[#1C5F7B] text-[45px] font-semibold text-left">
                  Aktuelle Aktionen
                </h2>
                    ...
                    <div className="slide-item">
                      <div className="product-card">
                        <div className="product-card-inner">
                          ...
                          <h4 className="pro-name text-[18px] text-[#292929] font-normal">
                          ...
                          <div className="price text-[24px] text-black font-bold mt-[12px] gap-[7px] flex flex-wrap items-center">
